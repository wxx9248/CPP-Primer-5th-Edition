...
<p>This loop increments <code>ix</code> and decrements <code>cnt</code> in the expression in the <code>for</code> header. Both <code>ix</code> and <code>cnt</code> are changed on each trip through the loop. As long as the test of <code>ix</code> succeeds, we reset the current element to the current value of <code>cnt</code>.</p>
