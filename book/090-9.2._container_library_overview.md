---
title: 9.2. Container Library Overview
---
...
<ul>
    <li>They refer to elements of, or one past the end of, the same container, and</li>
    <li>It is possible to reach <code>end</code> by repeatedly incrementing <code>begin</code>. In other words, <code>end</code> must not precede <code>begin</code>.</li>
</ul>
:::
::: warning
...
<a id="filepos2216888"></a><Badge type="tip" text="C++11" />
...
<a id="filepos2226442"></a><Badge type="tip" text="C++11" />
...
<a id="filepos2252464"></a><Badge type="tip" text="C++11" />
