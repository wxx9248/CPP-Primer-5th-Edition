...
<p>A <code>string</code> is a variable-length sequence of characters. To use the <code>string</code> type, we must include the <code>string</code> header. Because it is part of the library, <code>string</code> is defined in the <code>std</code> namespace. Our examples assume the following code:</p><ol></ol>
...
<img alt="Image" src="/images/00022.jpg"/>
...
<a id="filepos678006"></a><img alt="Image" src="/images/00008.jpg"/>
...
::: info
<p><a id="filepos682521"></a><strong>1.</strong> If two <code>string</code>s have different lengths and if every character in the shorter <code>string</code> is equal to the corresponding character of the longer <code>string</code>, then the shorter <code>string</code> is less than the longer one.</p>
:::

::: info
<p><strong>2.</strong> If any characters at corresponding positions in the two <code>string</code>s differ, then the result of the <code>string</code> comparison is the result of comparing the first character at which the <code>string</code>s differ.</p>
:::
...
<img alt="Image" src="/images/00024.jpg"/>
...
<a id="filepos702111"></a><img alt="Image" src="/images/00008.jpg"/>
