...
<a id="filepos4897184"></a><Badge type="tip" text="C++11" />
...
<p>These declarations both say that <code>recoup</code> won’t throw, but there are subtle distinctions between what the compiler is permitted to do with these declarations.</p>
:::
...
<a id="filepos4906788"></a><Badge type="tip" text="C++11" />
