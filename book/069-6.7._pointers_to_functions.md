...
<p><strong>Exercise 6.55:</strong> Write four functions that add, subtract, multiply, and divide two <code>int</code> values. Store pointers to these functions in your <code>vector</code> from the previous exercise.</p>
