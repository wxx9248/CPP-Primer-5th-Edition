...
<p>• The conversion from derived to base applies only to pointer or reference types.</p>
<p>• There is no implicit conversion from the base-class type to the derived type.</p>
<p>• Like any member, the derived-to-base conversion may be inaccessible due to access controls. We’ll cover accessibility in §<a href="146-15.5._access_control_and_inheritance.html#filepos3901534">15.5</a> (p. <a href="146-15.5._access_control_and_inheritance.html#filepos3901534">613</a>).</p>
...
<a id="filepos3868355"></a><img alt="Image" src="/images/00008.jpg"/>
...
::: warning
<a id="filepos3880356"></a><p>Warning</p>
