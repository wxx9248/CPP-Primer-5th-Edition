...
<p>Because <code>alloc</code> is a <code>static</code> member, it must be defined in the implementation file for <code>StrVec</code>:</p>

```c++
// definition for the static member of class StrVec
