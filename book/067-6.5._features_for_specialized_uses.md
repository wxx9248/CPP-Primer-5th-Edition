...
<p>Arguments in the call are resolved by position. The default arguments are used for the trailing (right-most) arguments of a call. For example, to override the default for <code>backgrnd</code>, we must also supply arguments for <code>ht</code> and <code>wid</code>:</p>
